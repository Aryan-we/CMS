...
<br>
    <div class="row" style=" margin: 10px auto; width: 90%;">
      <div class="col-12 mt-3 tabl">
        ...
        <li>Father Name: <?php echo "<font style='color:red;'>$father</font>" ?></li>
        <li>Mother Name: <?php echo "<font style='color:red;'>$mother</font>" ?></li>
        <li>Email: <?php echo "<font style='color:red;'>$email</font>" ?></li>
        <li>Mobile: <?php echo "<font style='color:red;'>$mobile</font>" ?></li>
        <li>Branch: <?php echo "<font style='color:red;'>$branch</font>" ?></li>
        <li>Course: <?php echo "<font style='color:red;'>$course</font>" ?></li>
        <li>Year: <?php echo "<font style='color:red;'>$year</font>" ?></li>
        <li>Fees: <?php echo "<font style='color:red;'>$fees</font>" ?></li>
