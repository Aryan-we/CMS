...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark custom-navbar-bg" style="background-color:#da2222;">
			...
			<div class="col-md-4">
				<form>
					...
					<div class="form-group">
						...
						<input type="text" value="<?php echo $role;?>" class="form-control" disabled>
					</div>
					<div class="form-group">
