          ...
          <div class="row">
              <div class="col-12 exam-section mt-2">
                <div class="col-lg-12 col-md-12 col-sm-12 place-exam-section">
                  <h1 style="text-transform: uppercase; text-shadow:2px 2px 5px rgba(255, 0, 0, 0.555)">Student Registration</h1>
                </div>
              </div>
            </div>
          </div>
<br>
    <div class="row" style="width: 90%; margin: 10px auto;">
      <div class="col-12 mt-3 tabl">
        ...
        <li>Father Name: <input type="text" placeholder="Enter Father Name" name="father" style="width:80%; border:none; outline:none; background-color:#eee;"></li>
        <li>Mother Name: <input type="text" placeholder="Enter Mother Name" name="mother" style="width:80%; border:none; outline:none; background-color:#eee;"></li>
        ...
        <li>Fees: <input type="text" placeholder="Enter Fees" name="fees" style="width:90%; border:none; outline:none; background-color:#eee;"></li>
        ...
        <li>Course: <input type="text" placeholder="Enter Course" name="course" style="width:70%; border:none; outline:none; background-color:#eee;"></li>
        ...
        <li>Branch: <input type="text" placeholder="Enter Branch" name="branch" style="width:70%; border:none; outline:none; background-color:#eee;"></li>
        <li>Year: <input type="text" placeholder="Enter Year" name="year" style="width:70%; border:none; outline:none; background-color:#eee;"></li>
...
if(!empty($name) and !empty($father) and !empty($mother) and !empty($mobile) and !empty($email) and !empty($branch) and !empty($course) and !empty($year) and !empty($password) and !empty($fees) and !empty($image) and $gender!="Not Selected" and !empty($location)){
$query="insert into student_details(name,father,mother,mobile,email,branch,course,year,password,fees,photo,gender,location) values('$name','$father','$mother','$mobile','$email','$branch','$course','$year','$password','$fees','$image','$gender','$location')";
